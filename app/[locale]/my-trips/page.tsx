          ...
          <div className="flex flex-col lg:flex-row gap-6">
            <div className="flex-1">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    <h3 className="text-2xl font-bold group-hover:text-brand-primary transition">Hotel #{booking.hotelId}</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3 p-3 bg-gradient-to-r from-brand-primary/10 to-brand-secondary/10 rounded-lg">
            ...
            <div className="lg:w-48 flex lg:flex-col gap-3 justify-end lg:justify-start">
              <Link href={`/${locale}/bookings/${booking.reference}`} className="flex-1 lg:flex-initial">
                <Button className="w-full bg-gradient-to-r from-brand-primary to-brand-primary-light hover:from-purple-700 hover:to-pink-700 rounded-lg shadow-lg hover:shadow-xl transition-all">
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-brand-primary/5 to-white">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-brand-primary to-brand-primary-light bg-clip-text text-transparent flex items-center gap-3">
            <Luggage className="w-10 h-10 text-brand-primary" />
        ...
        {bookings.length === 0 ? (
          <Card className="rounded-xl shadow-lg border-0">
            <CardContent className="p-16 text-center">
              ...
              <Link href={`/${locale}`}>
                <Button className="bg-gradient-to-r from-brand-primary to-brand-primary-light hover:from-purple-700 hover:to-pink-700 rounded-lg shadow-lg hover:shadow-xl transition-all" size="lg">
            ...
            {upcomingBookings.length > 0 && (
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-brand-primary to-brand-primary-light text-white rounded-full shadow-lg">
